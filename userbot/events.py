...
from userbot import bot, BOTLOG, BOTLOG_CHATID, LOGSPAMMER, BLACKLIST, me
...
def register(**args):
    ...
    trigger_on_fwd = args.get('trigger_on_fwd', True)
        ...
        async def wrapper(check):
            ...
            try:
                ...
                if not disable_errors:
                    ...
                    link = "[Fedai UserBot Support](https://t.me/FedaiUserBotSupport)"
