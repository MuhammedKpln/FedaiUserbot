...
from userbot import CMD_HELP, HEROKU_APIKEY, HEROKU_APPNAME, STRING_SESSION, UPSTREAM_REPO_URL
...
async def upstream(ups):
    ...
    if HEROKU_APIKEY != None:
        ...
        await ups.edit(
            ...
            '".alive" komutunu kullanarak userbotun çalışıp çalışmadığnıı kontrol edin.`')
